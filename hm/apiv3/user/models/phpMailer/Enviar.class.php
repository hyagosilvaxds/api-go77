...
class EnviarEmail extends Conexao {
    ...
    public function novoCadastro($nome, $email) {
      ...
      $mail->Subject = "Cadastro | " . NOME_REMETENTE; // Assunto da mensagem
      ...
      $html = "
          ...
          <body style='font-family: Arial, sans-serif;'>
              <div style='background-color: #f2f2f2; padding: 20px; text-align: center;'>
                  ...
                  <p>Seja bem vindo ao app ".NOME_REMETENTE.".</p>
                  <p>Faça seu login e aproveite de todas as funcionalidades presentes.</p>
    ...
    public function confirmarcadastro($email, $nome, $token){
      ...
      $mail->Body .= "Equipe Repasse, <br/><br/> ";
      $mail->Body .= "<img src='" . LOGO_EMAIL . "' width='120'>";
      $mail->Send();
    }

    public function recuperarsenha($nome, $email, $token,$tipo) {

      // print_r(LOGO_EMAIL);exit;
      if($tipo == 1){
        $tipo = "";
      }else{
        $tipo = "";
      ...
      $this->email_remetente = EMAIL_REMETENTE;
      $mail->From = EMAIL_REMETENTE; // Seu e-mail
      $mail->FromName = NOME_REMETENTE . " " . $tipo; // Seu nome
      //$this->logo_email = 'https://benditasmaes.com.br/views/_images/logo.png';
      $this->link_recuperar = LINK_RECUPERAR_SENHA . $token;
      $mail->AddAddress($email); //E-mail Destinatario
      $mail->IsHTML(true); // Define que o e-mail será enviado como HTML
      $mail->Subject = "Recuperar Senha " . " | " . NOME_REMETENTE; // Assunto da mensagem
      $mail->Body .= "Olá, <strong>" . ucwords($nome) . "</strong>, <br/><br/>";
      ...
      $mail->Body .= "Atenciosamente, <br/> ";
      $mail->Body .= "Equipe". NOME_REMETENTE ."<br/><br/> ";
      $mail->Body .= "<img src='" . LOGO_EMAIL . "' width='120'>";
    ...
    //   $this->email_remetente = EMAIL_REMETENTE;
    //   $mail->From = EMAIL_REMETENTE; // Seu e-mail
    //   $mail->FromName = "Repasse"; // Seu nome
    //   //$this->logo_email = 'https://benditasmaes.com.br/views/_images/logo.png';
    //   $mail->AddAddress($email); //E-mail Destinatario
    //   $mail->IsHTML(true); // Define que o e-mail será enviado como HTML
    //   $mail->Subject = "Código de verificação " . " | " . NOME_REMETENTE; // Assunto da mensagem
    //   $mail->Body .= "Olá, <strong>" . ucwords($nome) . "</strong>, <br/><br/>";
    //   $mail->Body .= "Para realizar o login, insira o código de verificação abaixo no seu app.<br /><br />";
    //   $mail->Body .= "<p>" ."Seu código é:". $codigo ."</p>" . "<br /><br />";
    //   $mail->Body .= "Atenciosamente, <br/> ";
    //   $mail->Body .= "Equipe Re.pass <br/><br/> ";
    //   $mail->Body .= "<img src='" . LOGO_EMAIL . "' width='120'>";
