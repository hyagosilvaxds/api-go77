...
// URL da home
define('HOME_URI', 'http://' . $dominiowww . $porta . '/www/hm/apiv3/user');
define('HOME_URI_ROOT', 'http://' . $dominiowww . $porta . '/www/hm');
...
define('COD_API', '$1$IYO8W82K$N.9AjuHhWF2S10kaE9kZn0');
define('LINK_API', '');
