function showInfoGerais() {
  ...
  document.getElementById("mostrarEstatisticas1").style.display = "none";
  ...
  document.getElementById("mostrarCupons").style.display = "none";
  document.getElementById("mostrarPlanos").style.display = "none";
  document.getElementById("mostrarPlanos1").style.display = "none";
  document.getElementById("aprovarUsuario").style.display = "none";
  document.getElementById("showImagens").style.display = "none";
}
function showImagens() {
  toggleActiveClass(event.currentTarget);
  document.getElementById("showImagens").style.display = "block";
...
function showAprovarUsuario() {
  toggleActiveClass(event.currentTarget);
  document.getElementById("aprovarUsuario").style.display = "block";
  document.getElementById("infoGerais").style.display = "none";
  document.getElementById("alterarSenha").style.display = "none";
  document.getElementById("mostrarEstatisticas").style.display = "none";
  document.getElementById("mostrarEstatisticas1").style.display = "none";
...
function showEstatisticas1() {
  ...
  document.getElementById("mostrarCupons").style.display = "none";
  document.getElementById("mostrarEstatisticas").style.display = "none";
  document.getElementById("mostrarEstatisticas1").style.display = "block";
  document.getElementById("aprovarUsuario").style.display = "none";
  document.getElementById("showImagens").style.display = "none";
}
...
function showPlanoAtual() {
  ...
  document.getElementById("mostrarLocalizacao").style.display = "none";
  document.getElementById("mostrarCupons").style.display = "none";
  document.getElementById("mostrarPlanos").style.display = "block";
    document.getElementById("mostrarPlanos1").style.display = "none";
  document.getElementById("aprovarUsuario").style.display = "none";
  document.getElementById("showImagens").style.display = "none";
}
function showPlanoAtual1() {
  toggleActiveClass(event.currentTarget);
  document.getElementById("infoGerais").style.display = "none";
  document.getElementById("alterarSenha").style.display = "none";
  document.getElementById("mostrarEstatisticas").style.display = "none";
  ...
  document.getElementById("mostrarCupons").style.display = "none";
  document.getElementById("mostrarPlanos").style.display = "none";
  document.getElementById("mostrarPlanos1").style.display = "block";
  document.getElementById("aprovarUsuario").style.display = "none";
  document.getElementById("showImagens").style.display = "none";
}
function showCupons() {
  ...
  document.getElementById("mostrarPlanos").style.display = "none";
    document.getElementById("mostrarPlanos1").style.display = "none";
  document.getElementById("mostrarCupons").style.display = "block";
  document.getElementById("aprovarUsuario").style.display = "none";
  document.getElementById("showImagens").style.display = "none";
}
