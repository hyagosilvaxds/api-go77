<script>
  ...
  new Vue({
    ...
    methods: {
      ...
      atualizaTaxa: function() {
        axios.post('<?php echo API ?>/fornecedores/atualizaTaxa/', {
            id_grupo:  '<?php echo $_SESSION['id_grupo'] ?>',
            id_usuario: this.id_user_selecionado,
            taxa_mes:  this.taxa_mes,
            taxa_perc: this.taxa_perc,
            token: '<?php echo TK ?>'
          })
          .then(res => {
      ...
      listPendentes: function() {
          ...
          axios.post('<?php echo API ?>/anuncios/listaPendentes/', {
              id_grupo:  '<?php echo $_SESSION['id_grupo'] ?>',
              limite:  1000,
              token: '<?php echo TK ?>'
            })
    ...
    pegaDadosTaxa(id,mes,perc){
      this.id_user_selecionado = id;
      this.taxa_mes = mes;
      this.taxa_perc = perc;
    },
  ...
  ListIdCadastros: function(id) {
    ...
    axios.post('<?php echo API ?>/usuarios/updateUsuarioAdmin/', {
      ...
      aprovaCadastro: function(id) {
        ...
        axios.post('<?php echo API ?>/anuncios/aprovar/', {
        id:  id,
        status_aprovado:  1,
        token: '<?php echo TK ?>'
