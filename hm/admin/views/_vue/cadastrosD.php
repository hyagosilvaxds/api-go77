<script>
  ...
  new Vue({
    ...
    data: {
      ...
      listallplanos: [],
      listallcupons: [],
      id_usuario: window.location.href.split("cadastrosD/")[1].split("#")[0],
      nome_visita: null,
      numero_estudo: null,
      saldo_atual:null,
      ...
      cpf_usuario: null,
      cnpj_usuario: null,
      razao_social_usuario: null,
      nome_fantasia_usuario: null,
      ie_usuario: null,
      ...
      saldo_usuario: null,
      perc_imoveis_usuario: null,
      perc_eventos_usuario: null,
      data_cadastro_usuario: null,

      nome_usuario_update: null,
      email_usuario_update: null,
      cpf_usuario_update: null,
      celular_usuario_update: null,
      chave_usuario_update: null,
      status_usuario_update: "",
      data_nascimento_usuario_update: null,
      saldo_usuario_update: null,
      perc_imoveis_usuario_update: null,
      perc_eventos_usuario_update: null,
      data_cadastro_usuario_update: null,
  ...
  ListIdCadastros: function() {
    axios.post('<?php echo API ?>/cadastros/perfil', {
        id:this.id_usuario,
      ...
      .then(res => {
        ...
        this.tipo_pessoa = res.data.tipo_pessoa;
        this.nome_usuario = res.data.nome;
        this.email_usuario = res.data.email;
        this.cpf_usuario = res.data.cpf;
        this.cnpj_usuario = res.data.cnpj;
        this.razao_social_usuario = res.data.razao_social;
        this.nome_fantasia_usuario = res.data.nome_fantasia;
        this.ie_usuario = res.data.ie;

        this.celular_usuario = res.data.celular;
        this.chave_usuario = res.data.chave;
        this.status_usuario = res.data.status;
        this.data_nascimento_usuario = res.data.data_nascimento;
        this.saldo_usuario = res.data.saldo;
        this.perc_imoveis_usuario = res.data.perc_imoveis;
        this.perc_eventos_usuario = res.data.perc_eventos;
        this.data_cadastro_usuario = res.data.data_cadastro;

        this.nome_usuario_update = res.data.nome;
        this.email_usuario_update = res.data.email;
        this.cpf_usuario_update = res.data.cpf;
        this.celular_usuario_update = res.data.celular;
        this.chave_usuario_update = res.data.chave;
        this.status_usuario_update = res.data.status;
        this.data_nascimento_usuario_update = res.data.data_nascimento;
        this.saldo_usuario_update = res.data.saldo;
        this.perc_imoveis_usuario_update = res.data.perc_imoveis;
        this.perc_eventos_usuario_update = res.data.perc_eventos;
        this.data_cadastro_usuario_update = res.data.data_cadastro;
  ...
  deletaEndereco: function(id) {
    axios.post('<?php echo API_ROOT ?>/usuarios/deleteEndereco/', {
        id_endereco:  id,
        token: '72J77vQa'
  ...
  if( this.cep_modal.length > 8){
    ...
    .then((res)=> {
      ...
      updateendereco: function() {
          axios.post('<?php echo API ?>/cadastros/updateEndereco/', {
            id_usuario: this.id_usuario,
...
buscaCNPJ: function() {
				...
				.then(res => {
					...
					if(res.data.razao_social){
						...
						this.nome_usuario_update = res.data.nome_responsavel;
						this.nome_fantasia_update = res.data.nome_fantasia;
  ...
  updateCadastro: function() {
        axios.post('<?php echo API ?>/cadastros/updateCadastro/', {
            ...
            email:this.email_usuario_update,
            celular:this.celular_usuario_update,
            data_nascimento:this.data_nascimento_usuario_update,
            documento:this.cpf_usuario_update,
            perc_imoveis:this.perc_imoveis_usuario_update,
            perc_eventos:this.perc_eventos_usuario_update,
            status:this.status_usuario_update,
            token:'<?php echo TK ?>'
        })
        .then(res => {
            console.log(res.data.status)
  ...
  EstatisticasGerais: function() {
    axios.post('<?php echo API ?>/cadastros/EstatisticasGerais/', {
      id_usuario:this.id_usuario,
        token: '<?php echo TK ?>'
      })
      .then(res => {
    ...
    axios.post('<?php echo API ?>/cadastros/deleteCadastro/', {
      ...
      watch:{
      'perc_imoveis_usuario_update' () {
                var perc_imoveis_usuario_update = this.perc_imoveis_usuario_update.replace(/\D/g, '')
                perc_imoveis_usuario_update = (perc_imoveis_usuario_update / 100).toFixed(2) + ''
                perc_imoveis_usuario_update = perc_imoveis_usuario_update.replace(',', '.')
                perc_imoveis_usuario_update = perc_imoveis_usuario_update.replace(/(\d)(\d{3})(\d{3}),/g, '$1.$2.$3,')
                perc_imoveis_usuario_update = perc_imoveis_usuario_update.replace(/(\d)(\d{3}),/g, '$1.$2,')
                this.perc_imoveis_usuario_update =  perc_imoveis_usuario_update
            },
      'perc_eventos_usuario_update' () {
                var perc_eventos_usuario_update = this.perc_eventos_usuario_update.replace(/\D/g, '')
                perc_eventos_usuario_update = (perc_eventos_usuario_update / 100).toFixed(2) + ''
                perc_eventos_usuario_update = perc_eventos_usuario_update.replace(',', '.')
                perc_eventos_usuario_update = perc_eventos_usuario_update.replace(/(\d)(\d{3})(\d{3}),/g, '$1.$2.$3,')
                perc_eventos_usuario_update = perc_eventos_usuario_update.replace(/(\d)(\d{3}),/g, '$1.$2,')
                this.perc_eventos_usuario_update = perc_eventos_usuario_update
            },
          },
    created() {
      this.ListIdCadastros();
