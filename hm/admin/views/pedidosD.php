...
<title>Detalhes do Pedido | <?php echo TITLE; ?></title>
...
<?php require_once 'views/_include/style/cadastrosD.php'; ?>
    ...
    <?php require 'views/_include/headeradm.php'; ?>
            ...
            <div id="pedidosDetalhes" class="hp-main-layout-content">
                        ...
                        <div class="row bg-black-0 hp-bg-color-dark-100 rounded pe-16 pe-sm-20 mx-0">
                            ...
                            <div class="col hp-profile-menu py-24 songoku justify-content-start">
                                <div class="w-100">
                                    ...
                                    <a style="float:left;" href="<?php echo HOME_URI ?>/pedidos"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 2.25 2.25" xml:space="preserve"><path d="M1.508 2.164a.264.264 0 0 1-.188-.078l-.766-.765a.266.266 0 0 1-.077-.195A.266.266 0 0 1 .554.93L1.32.164a.264.264 0 0 1 .188-.078.266.266 0 0 1 .188.454l-.586.585.586.586a.266.266 0 0 1 0 .376.264.264 0 0 1-.188.078zm0-1.953a.14.14 0 0 0-.099.041l-.752.766c-.028.028-.026.065-.026.105v.005c0 .04-.002.077.026.105l.758.766a.13.13 0 0 0 .096.041.14.14 0 0 0 .097-.24l-.63-.631a.063.063 0 0 1 0-.088l.629-.63a.141.141 0 0 0 0-.199.14.14 0 0 0-.1-.041z"></path></svg></a>
                                            ...
                                            <div class="col-12 hp-profile-content-list mt-8 pb-0 pb-sm-120">
                                                <ul>
                                                    <li class="">
                                                        ...
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allpedidos.categoria_nome}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Data</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allpedidos.data_cadastro}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Cidade</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allpedidos.cidade}}-{{allpedidos.estado}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Status</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allpedidos.status}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Descricao</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allpedidos.descricao}}</span>
                                                    </li>
...
<?php require 'views/_vue/pedidosD.php'; ?>
</body>
