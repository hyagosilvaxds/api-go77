...
class PedidosController {
    ...
    public function listAllPedidos()
    {
        ...
        $cadastros = new Pedidos();
        $consultacadastros = $cadastros->listAllPedidos($this->input->id_usuario,$this->input->nome,dataUS($this->input->data_de),dataUS($this->input->data_ate),
    ...
    public function deletePedidos()
    {
        ...
        $consultacadastros = $cadastros->deletePedidos($this->input->id);
