...
<head>
  ...
  <title>Setores | <?php echo TITLE; ?></title>
  ...
  <body>
    ...
    <?php require 'views/_include/headeradm.php'; ?>
            ...
            <div id="setores" class="hp-main-layout-content">
                                                                ...
                                                                <tr v-if="empty_notificacoes">
                                                                    ...
                                                                    <tr v-else v-for="cupom of allcupons">
                                                                        ...
                                                                        <td class="text-center">
                                                                            <span class="mb-0 text-black-80 hp-text-color-dark-30">{{cupom.id}}</span>
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <span class="mb-0 text-black-80 hp-text-color-dark-30">{{cupom.nome}}</span>
                                                                        </td>
            
                                                                       
                                                                        <td class="text-center">
                                                                            <div class="actionbuttons">
                                                                            <button @click="deleteSetor(cupom.id)" class="iconly-Light-Delete hp-cursor-pointer hp-transition hp-hover-text-color-danger-1 text-black-80 lixeira bg-transparent"></button>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header py-16 px-24">
                                    <h5 class="modal-title" id="addNewProdLabel">Novo Setor</h5>
                                        ...
                                        <div class="row gx-8">
                                            ...
                                            <div  class="col-12 col-md-6">
                                                <div class="mb-24">
                                                    ...
                                                    <input type="text" v-model="nome" class="form-control" placeholder="Insira o nome" id="name">
                                                </div>
                                            </div>
                                            <!-- <div  class="col-12 col-md-6">
                                                <div class="mb-24">
                                                    ...
                                                    <input type="text" v-model="descricao" class="form-control" placeholder="Insira a descrição" id="name">
                                                </div>
                                            </div> -->
    ...
    <?php require 'views/_vue/setores.php'; ?>
</body>
