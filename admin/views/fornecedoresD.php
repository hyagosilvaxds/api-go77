...
<title>Detalhes do fornecedor | <?php echo TITLE; ?></title>
                        ...
                        <div class="row bg-black-0 hp-bg-color-dark-100 rounded pe-16 pe-sm-20 mx-0">
                            ...
                            <div class="col hp-profile-menu py-24 songoku justify-content-start">
                                <div class="w-100">
                                    ...
                                    <a style="float:left;" href="<?php echo HOME_URI ?>/fornecedores"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 2.25 2.25" xml:space="preserve"><path d="M1.508 2.164a.264.264 0 0 1-.188-.078l-.766-.765a.266.266 0 0 1-.077-.195A.266.266 0 0 1 .554.93L1.32.164a.264.264 0 0 1 .188-.078.266.266 0 0 1 .188.454l-.586.585.586.586a.266.266 0 0 1 0 .376.264.264 0 0 1-.188.078zm0-1.953a.14.14 0 0 0-.099.041l-.752.766c-.028.028-.026.065-.026.105v.005c0 .04-.002.077.026.105l.758.766a.13.13 0 0 0 .096.041.14.14 0 0 0 .097-.24l-.63-.631a.063.063 0 0 1 0-.088l.629-.63a.141.141 0 0 0 0-.199.14.14 0 0 0-.1-.041z"></path></svg></a>
                                    ...
                                    <div class="col-12">
                                        <div class="row align-items-center justify-content-between">
                                            ...
                                            <div class="col-12 hp-profile-content-list mt-8 pb-0 pb-sm-120">
                                                <ul>
                                                    <li class="mt-18 ">
                                                        <span class="hp-p1-body margin_right">Nome fantasia</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{nome_usuario}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">Nome responsável</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allusuariosdados.nome_responsavel}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">Email</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{email}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">Celular</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{celular}}</span>
                                                    </li> 
                                                    <!-- <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">Tempo de resposta</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allusuariosdados.tempo_resposta}}</span>
                                                    </li> -->
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">Taxa Mensal</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">R$ {{allusuariosdados.taxa_mensal}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">Comissão %</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allusuariosdados.taxa_perc}} %</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">CNPJ</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allusuariosdados.documento}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">Razão social</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allusuariosdados.razao_social}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">Inscrição estadual</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allusuariosdados.ie}}</span>
                                                    </li>
                                                    
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">Status</span>
                                            ...
                                            <div class="col-12 hp-profile-content-list mt-8 pb-0 pb-sm-60">
                                                <ul>
                                                    <li class="">
                                                        ...
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.pedidos_qtd}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Vendas qtd.</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.vendas_qtd}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Vendas R$</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.vendas_total}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Franqueador</span>
                                                        <a :href="'<?php echo HOME_URI ?>/franqueadosD/'+allestatisticas.id_franqueador">{{allestatisticas.franqueador_nome}}</a>
                                                        <!-- <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.franqueador_nome}}</span> -->
                                                    </li>
                                                    <!-- <li class="mt-18">
                                                        <span class="hp-p1-body">Clientes</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.total_clientes}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Pacotes</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.total_pacotes}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Receita</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.total_receita}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Despesa</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.total_despesa}}</span>
                                                    </li> -->
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div id="mostrarCupons" class="col pe-0 py-24 py-sm-32 overflow-hidden hidden">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <button type="button" data-bs-toggle="modal" @click="limpamodalcupons" data-bs-target="#saveNewCupom" class="btn btn-ghost btn-primary flutuar mb-4">Nova</button>
                                    </div>
                                    <div class="col-12">
                                        <div class="rounded-top border-start border-end border-top border-black-40 hp-border-color-dark-80">
                                            <div class="table-responsive" style="overflow-x: auto;">
                                                <table class="table mb-0">
                                                    ...
                                                    <tbody>
                                                    <tr v-if="userCategorias[0].rows == 0">
                                                    <td colspan="5" class="text-center">Nenhum registro cadastrado.</td>
                                                    </tr>
                                                        <tr v-else v-for="item of userCategorias">
                                                             <td class="ps-0 text-center photolist">
                                                                <div  style="height:50px;" class="avatar-item-company d-flex align-items-center justify-content-center imagerolltwo">
                                                                    <img  style="height:40px;" :src="'<?php echo CATEGORIAS;?>/'+item.url">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <button @click="deleteCategorias(item.id)" class="iconly-Light-Delete hp-cursor-pointer hp-transition hp-hover-text-color-danger-1 text-black-80 lixeira bg-transparent"></button>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body py-48">
                                <form @submit.prevent="updateCadastro">
                                    <div class="row g-24">
                                        <div class="col-6">
                                            <label for="fullName" class="form-label">Nome fantasia</label>
                                            <input type="text" v-model="nome_usuario_update" class="form-control" placeholder="Nome">
                                        </div>
                                        <div class="col-6">
                                            <label for="fullName" class="form-label">Nome responsável</label>
                                            <input type="text" v-model="nome_responsavel_update" class="form-control" placeholder="Nome">
                                        </div>
                                        ...
                                        <!-- <div class="col-4">
                                            <label for="displayName" class="form-label">Tempo de resposta</label>
                                            <input type="text" v-model="tempo_resposta_update" class="form-control" placeholder="">
                                        </div> -->

                                        <div class="col-6">
                                            <label for="displayName" class="form-label">Taxa mensal ($)</label>
                                            <input type="text" v-model="taxa_mensal_update" class="form-control" placeholder="">
                                        </div>

                                        <div class="col-6">
                                            <label for="displayName" class="form-label">Taxa comissão(%)</label>
                                            <input type="number" v-model="taxa_perc_update" min="0" step="0.01" class="form-control" placeholder="">
                                        </div>
        
                                        <div class="col-6">
                                            <label for="displayName" class="form-label">CNPJ</label>
                                            <input required type="text" class="form-control" placeholder="Insira o CNPJ" @blur.prevent="buscaCNPJ" v-mask="'##.###.###/####-##'" v-model="cnpj_update" >
                                        </div>
                                        <div class="col-6">
                                            <label for="displayName" class="form-label">Razão social</label>
                                            <input type="text" v-model="razao_social_update" class="form-control" placeholder="">
                                        </div>
                                        <div class="col-6">
                                            <label for="displayName" class="form-label">Inscrição estadual</label>
                                            <input type="text" v-model="ie_update" class="form-control" placeholder="">
                                        </div>
                ...
                <div class="modal fade" id="editarEndereco" tabindex="-1" aria-labelledby="editarEnderecoLabel" aria-hidden="true">
                    ...
                    <div class="modal fade" id="saveNewCupom" tabindex="-1" aria-labelledby="saveNewCupomLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header py-16 px-24">
                                    <h5 class="modal-title" id="saveNewCupomLabel">Adicionar categoria</h5>
                                    <button type="button" class="btn-close hp-bg-none d-flex align-items-center justify-content-center" data-bs-dismiss="modal" aria-label="Close">
                                        <i class="ri-close-line hp-text-color-dark-0 lh-1 lorden"></i>
                                    </button>
                                </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select v-model="categoria_modal" placeholder="seleciona a categoria" class="form-control">
                                                    <option value="" selected  disabled>Selecione a categoria</option>
                                                    <option v-for="item of allcategorias" :value="item.id">{{item.nome}}</option>
                                                </select>
                                            </div>
                                        </div>
...
<?php require 'views/_vue/fornecedoresD.php'; ?>
</body>
