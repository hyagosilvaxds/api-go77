...
<title>Detalhes do comprador | <?php echo TITLE; ?></title>
                        ...
                        <div class="row bg-black-0 hp-bg-color-dark-100 rounded pe-16 pe-sm-20 mx-0">
                            ...
                            <div class="col hp-profile-menu py-24 songoku justify-content-start">
                                <div class="w-100">
                                    ...
                                    <a style="float:left;" href="<?php echo HOME_URI ?>/cadastros"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 2.25 2.25" xml:space="preserve"><path d="M1.508 2.164a.264.264 0 0 1-.188-.078l-.766-.765a.266.266 0 0 1-.077-.195A.266.266 0 0 1 .554.93L1.32.164a.264.264 0 0 1 .188-.078.266.266 0 0 1 .188.454l-.586.585.586.586a.266.266 0 0 1 0 .376.264.264 0 0 1-.188.078zm0-1.953a.14.14 0 0 0-.099.041l-.752.766c-.028.028-.026.065-.026.105v.005c0 .04-.002.077.026.105l.758.766a.13.13 0 0 0 .096.041.14.14 0 0 0 .097-.24l-.63-.631a.063.063 0 0 1 0-.088l.629-.63a.141.141 0 0 0 0-.199.14.14 0 0 0-.1-.041z"></path></svg></a>
                                ...
                                <div class="hp-profile-menu-body w-100 text-start mt-48 mt-lg-0">
                                    <ul class="me-n1 mx-lg-n12">
                                        ...
                                        <li style="display:done;" class="mt-4 mb-16">
                                        ...
                                        <div class="row align-items-center justify-content-between">
                                            ...
                                            <div class="col-12 hp-profile-content-list mt-8 pb-0 pb-sm-120">
                                                ...
                                                <ul>
                                                  ...
                                                  <li class="mt-18">
                                                      <span class="hp-p1-body margin_right">Tipo Pessoa</span>
                                                      <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{tipo_pessoa}}</span>
                                                  </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">Nome Completo</span>
                                                    ...
                                                    <li class="mt-18">
                                                        ...
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{celular_usuario}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">CPF</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{cpf_usuario}}</span>
                                                    </li>

                                                    <div v-if="tipo_pessoa == 'Jurídica'">

                                                      <li class="mt-18">
                                                          <span class="hp-p1-body margin_right">CNPJ</span>
                                                          <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{cnpj_usuario}}</span>
                                                      </li>
                                                      <li class="mt-18">
                                                          <span class="hp-p1-body margin_right">Razão Social</span>
                                                          <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{razao_social_usuario}}</span>
                                                      </li>
                                                      <li class="mt-18">
                                                          <span class="hp-p1-body margin_right">Nome Fantasia</span>
                                                          <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{nome_fantasia_usuario}}</span>
                                                      </li>
                                                      <li class="mt-18">
                                                          <span class="hp-p1-body margin_right">IE</span>
                                                          <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{ie_usuario}}</span>
                                                      </li>

                                                    </div>

                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">Data de Nascimento</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{data_nascimento_usuario}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">Chave PIX</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{chave_usuario}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">Saldo a receber</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{saldo_usuario}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">% hospedagens</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{perc_imoveis_usuario}}%</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">% experiências</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{perc_eventos_usuario}}%</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body margin_right">Data de cadastro</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{data_cadastro_usuario}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                    ...
                                    <div class="col-12">
                                        <div class="row align-items-center justify-content-between">
                                            ...
                                            <div class="col-12 hp-profile-content-list mt-8 pb-0 pb-sm-60">
                                                <ul>
                                                    <li class="">
                                                        <span class="hp-p1-body">Anúncios ativos</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.anuncios_ativos}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Anúncios pendentes</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.anuncios_pendentes}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Total em pagamentos</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.pagamentos_total}}</span>
                                                    </li>

                                                     <li class="mt-18">
                                                        <span class="hp-p1-body">Avaliações</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.avaliacoes}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Favoritos</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.favoritos}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Push Notifications</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.push}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Reservas</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.reservas}}</span>
                                                    </li>
                                                    <li class="mt-18">
                                                        <span class="hp-p1-body">Sistema Celular</span>
                                                        <span class="mt-0 mt-sm-4 hp-p1-body text-black-100 hp-text-color-dark-0">{{allestatisticas.tipo_fcm}}</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <form @submit.prevent="updateCadastro">
                                    <div class="row g-24">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" v-model="nome_usuario_update" class="form-control" placeholder="Nome Completo">
                                        </div>

                                        <div class="col-6">
                                            <label for="fullName" class="form-label">CPF</label>
                                            <input required type="text" class="form-control" placeholder="Insira o CPF" v-model="cpf_usuario_update" v-mask="'###.###.###-##'">
                                        </div>

                                        <div class="col-6">
                                            <label for="displayName" class="form-label">Celular</label>
                                            <input type="text" v-model="celular_usuario_update" class="form-control" placeholder="Celular" v-mask="'(##) #####-####'">
                                        </div>

                                        <div class="col-6">
                                            <label for="fullName" class="form-label">Data de Nascimento</label>
                                            <input type="text" v-model="data_nascimento_usuario_update" class="form-control" placeholder="Data de Nascimento" v-mask="'##/##/####'">
                                        </div>

                                        <div class="col-6">
                                            <label for="fullName" class="form-label">% Imóveis</label>
                                            <input type="text" v-model="perc_imoveis_usuario_update" class="form-control" placeholder="% Imóveis">
                                        </div>

                                        <div class="col-6">
                                            <label for="fullName" class="form-label">% Experiências</label>
                                            <input type="text" v-model="perc_eventos_usuario_update" class="form-control" placeholder="% Experiências">
                                        </div>
...
<?php require 'views/_vue/cadastrosD.php'; ?>
</body>
