<script>
  ...
  new Vue({
    ...
    data: {
      ...
      listallplanos: [],
      listallcupons: [],
      id_usuario: window.location.href.split("pedidosD/")[1].split("#")[0],
      nome_visita: null,
      numero_estudo: null,
      saldo_atual:null,
  ...
  ListIdDadosAprovados: function() {
    axios.post('<?php echo API ?>/pedidos/ListIdDadosAprovados/', {
      id_usuario:this.id_usuario,
        token: '<?php echo TK ?>'
      })
      .then(res => {
  ...
  if( this.cep_modal.length > 8){
    ...
    .then((res)=> {
      ...
      updateendereco: function() {
          axios.post('<?php echo API ?>/pedidos/updateEndereco/', {
            id_usuario: this.id_usuario,
      ...
      updatePlanos: function() {
          axios.post('<?php echo API ?>/pedidos/updatePlanos/', {
            id_usuario: this.id_usuario,
  ...
  listAllPagamentos: function() {
    axios.post('<?php echo API ?>/pedidos/listAllPagamentos/', {
      id_usuario:this.id_usuario,
        token: '<?php echo TK ?>'
      })
      .then(res => {
  ...
  listAllCupons: function() {
    axios.post('<?php echo API ?>/pedidos/listAllCupons/', {
      id_usuario:this.id_usuario,
        token: '<?php echo TK ?>'
      })
      .then(res => {
  ...
  ListIdCupons: function(id) {
    axios.post('<?php echo API ?>/pedidos/ListIdCupons/', {
      id_cupom:id,
        token: '<?php echo TK ?>'
      })
      .then(res => {
  ...
  updateCupons: function() {
      ...
      axios.post('<?php echo API ?>/pedidos/updateCupons', {
  ...
  listAllPlanos: function() {
    axios.post('<?php echo API ?>/pedidos/listAllPlanos/', {
        token: '<?php echo TK ?>'
      })
      .then(res => {
  ...
  updatepassword: function() {
    ...
    if (this.password === this.password2) {
        axios.post('<?php echo API ?>/pedidos/updatepassword/', {
          id_usuario:this.id_usuario,
  ...
  updateCadastro: function() {
        axios.post('<?php echo API ?>/pedidos/updateCadastro/', {
            id_usuario:this.id_usuario,
  ...
  EstatisticasGerais: function() {
    axios.post('<?php echo API ?>/pedidos/EstatisticasGerais/', {
      id_usuario:this.id_usuario,
        token: '<?php echo TK ?>'
      })
      .then(res => {
    ...
    axios.post('<?php echo API ?>/usuarios/updateUsuarioAdmin/', {
      ...
      axios.post('<?php echo API ?>/pedidos/saveCupons', {
    ...
    axios.post('<?php echo API ?>/pedidos/deleteCadastro/', {
        id_usuario:  id,
        token: '<?php echo TK ?>'
